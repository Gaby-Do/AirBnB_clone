...
class TestBaseModel(unittest.TestCase):
    ...
    def test_str(self):
        """testing str method"""
        my_model = BaseModel()
        model_str = f'[{BaseModel.__name__}] ({my_model.id}) {my_model.__dict__}'
        self.assertEqual(model_str, str(my_model))
    ...
    def test_base_model(self):
        ...
        my_model.save()
        second_json = my_model.to_dict()
        self.assertNotEqual(my_model_json['name'], second_json['name'])
        self.assertNotEqual(my_model.created_at, my_model.updated_at)
        self.assertEqual(my_model_json['created_at'], second_json['created_at'])
        new_obj = BaseModel(**second_json)
        new_obj.save()
        new_json = new_obj.to_dict()
        self.assertDictEqual(second_json, new_json)
